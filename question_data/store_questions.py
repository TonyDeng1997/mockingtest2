...
def main(args):
    ...
    try:
        db = MySQLdb.connect("localhost", db_user, db_pass, "mocking_test", charset='utf8')
        cursor = db.cursor()

        try:
            sql = "ALTER TABLE question_data MODIFY COLUMN DESCRIPTION LONGTEXT;"
            cursor.execute(sql)
    ...
    for question in data:
        ...
        sql = "INSERT INTO question_data(answer, description, title) \
